...
impl GroundControlStation {
    ...
    pub async fn tick(&mut self) {
        ...
        let uplink_msg = self.usb.next_uplink_message().await.and_then(|msg| {
            match msg {
        ...
        let rssi_led = (self.time.0 % 100) > (self.radio.trx.rssi as u32);
        ...
        if let Some(msg) = downlink_msg {
            ...
            self.usb.send_message(gcs_message).await;
        }
