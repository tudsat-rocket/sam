    ...
    fn ui(&mut self, ui: &mut Ui, app_settings: Option<&AppSettings>) -> InnerResponse<()> {
        egui::Grid::new("fc_settings_grid")
            ...
            .show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    ui.weak("kP");
                    ui.add(DragValue::new(&mut self.mahony_kp)
                           .speed(0.001)
                           .clamp_range(0.0..=10.0));

                    ui.weak(" kI");
                    ui.add(DragValue::new(&mut self.mahony_ki)
                           .speed(0.001)
                           .clamp_range(0.0..=10.0));
                });
                ui.end_row();
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.add(DragValue::new(&mut self.std_dev_accelerometer)
                           .speed(0.001)
                           .clamp_range(0.0..=10.0));

                    ui.weak(" barometer");
                    ui.add(DragValue::new(&mut self.std_dev_barometer)
                           .speed(0.001)
                           .clamp_range(0.0..=10.0));

                    ui.weak(" process");
                    ui.add(DragValue::new(&mut self.std_dev_process)
                           .speed(0.001)
                           .clamp_range(0.0..=10.0));
                });
                ui.end_row();
                ...
                ui.horizontal(|ui| {
                    ui.weak("at least");
                    ui.add(DragValue::new(&mut self.min_takeoff_acc)
                           .suffix(" m/s²")
                           .speed(0.1)
                           .clamp_range(0.0..=1000.0));
                    ui.weak("for");
                    ui.add(DragValue::new(&mut self.min_takeoff_acc_time)
                           .suffix(" ms")
                           .speed(1)
                           .clamp_range(0..=1000));
                });
                ...
                ui.horizontal(|ui| {
                    ui.weak("between");
                    ui.add(DragValue::new(&mut self.min_time_to_apogee)
                           .suffix(" ms")
                           .speed(1)
                           .clamp_range(0..=1000000));
                    ui.weak("and");
                    ui.add(DragValue::new(&mut self.max_time_to_apogee)
                           .suffix(" ms")
                           .speed(1)
                           .clamp_range(0..=1000000));
                    ui.weak("post-launch, after falling for");
                    ui.add(DragValue::new(&mut self.apogee_min_falling_time)
                           .suffix(" ms")
                           .speed(1)
                           .clamp_range(0..=10000));
                });
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.selectable_value(&mut self.main_output_mode, MainOutputMode::BelowAltitude, "below altitude of ");
                    ui.add(DragValue::new(&mut self.main_output_deployment_altitude)
                           .suffix(" m")
                           .speed(0.1)
                ...
                ui.horizontal(|ui| {
                    ui.weak("enabled for");
                    ui.add(DragValue::new(&mut self.outputs_high_time)
                           .suffix(" ms")
                           .speed(1)
                           .clamp_range(0..=10000));
                    ui.weak("after");
                    ui.add(DragValue::new(&mut self.outputs_warning_time)
                           .suffix(" ms")
                           .speed(1)
                           .clamp_range(0..=10000));
                    ui.weak("of");
