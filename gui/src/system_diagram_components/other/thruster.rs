...
const POSITIONS: [Point2<f32>; 9]= [Point2::new(-0.5, -0.5), Point2::new(-0.5, -0.5 + CHAMBER_LENGTH), Point2::new(-THROAT_RADIUS, 0.5 - DIVERGING_LENGTH), Point2::new(-0.5, 0.5), Point2::new(0.5, 0.5), Point2::new(THROAT_RADIUS, 0.5 - DIVERGING_LENGTH), Point2::new(0.5, -0.5 + CHAMBER_LENGTH), Point2::new(0.5, -0.5), Point2::new(-0.5, -0.5)];
