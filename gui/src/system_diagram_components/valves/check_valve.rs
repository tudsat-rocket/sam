...
use crate::{system_diagram_components::{core::constants::STROKE_WIDTH, math::{conversions::to_pos, transform::Transform}, primitives}, utils::theme::ThemeColors};


const POSITIONS: [Point2<f32>; 4] = [Point2::new(-0.5, -0.5), Point2::new(-0.5, 0.5), Point2::new(0.5, 0.5), Point2::new(0.5, -0.5)];
...
pub fn paint(transform: &Affine2<f32>, painter: &egui::Painter, theme: &ThemeColors) {
    ...
    let arrow_transform = Transform::new(Rotation2::new(f32::consts::FRAC_PI_4), Scale2::new(1.2, 0.2), Translation2::identity()).to_affine2();
