...
use crate::{system_diagram_components::{core::constants::STROKE_WIDTH, math::{conversions::to_pos, utils::gather}}, utils::theme::ThemeColors};
...
const POSITIONS: [Point2<f32>; 4] = [Point2::new(0.0, 0.0), Point2::new(0.0, -HANDLE_LENGTH), Point2::new(-HANDLE_WIDTH/2f32, -HANDLE_LENGTH), Point2::new(HANDLE_WIDTH/2f32, -HANDLE_LENGTH)];
