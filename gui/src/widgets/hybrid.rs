...
use crate::{
    flow_components::{
        ...
        flow_component::{
            ComponentInfo, DisplayValue, FillState, FlowComponent, FluidType, Justification, JustifiedValue, Value, TEST_SENSOR
        },
        line::{LinePainter1D, LinePainter2D},
        sensor::SymbolPainter,
        tank::TankPainter,
        valve::{BallValvePainter, TankValvePainter, ValvePainter, CheckValvePainter},
    },
    ...
    pub fn new() -> Self {
        ...
        Self { components: vec![
            ...
            FlowComponent::new(
                ...
                Box::new(BottlePainter::new(Pos2::new(0.15, 0.5), 0.2, 0.6, /*60.0,*/ FillState::new(FluidType::N2O, 0.3))),
                None
            ),
            ...
            FlowComponent::new(
                ...
                Box::new(TankPainter::new(Vec2::new(0.4, 0.5), 0.15, 0.4, /*300.0,*/ FillState::new(FluidType::N2, 0.6))),
            ...
            FlowComponent::new(
                ...
                Box::new(TankPainter::new(Vec2::new(0.6, 0.5), 0.15, 0.4, /*60.0,*/ FillState::new(FluidType::ETHANOL, 0.2))),
                None
            ),
