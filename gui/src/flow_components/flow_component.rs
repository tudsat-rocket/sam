...
pub const JUSTIFICATION_MEASRURED_PATTERN: &'static [u8] = include_bytes!("./../../assets/textures/full_pattern_32x32.png").as_slice();
pub const JUSTIFICATION_REASONED_PATTERN: &'static [u8] = include_bytes!("./../../assets/textures/diagonal_pattern_32x32.png").as_slice();
pub const JUSTIFICATION_PROCESS_PATTERN: &'static [u8] = include_bytes!("./../../assets/textures/crosshatch_pattern_32x32.png").as_slice();
pub const JUSTIFICATION_NONE_PATTERN: &'static [u8] = include_bytes!("./../../assets/textures/dots_pattern_32x32.png").as_slice();
