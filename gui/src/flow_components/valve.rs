use egui::{
    epaint::{CircleShape, EllipseShape, PathShape},
    Pos2, Rect, Shape, Stroke, Ui, Vec2,
};
...
use super::{
    constants::{
        BALL_VALVE_SYMBOL_DISTANCE, BALL_VALVE_SYMBOL_RADIUS, CHECK_VALVE_PADDING, CHECK_VALVE_SPIKE_NUM, STROKE_WITH,
        TANK_VALVE_HANDLE_LENGTH, TANK_VALVE_HANDLE_WIDTH,
    },
...
impl ComponentPainter for ValvePainter {
    fn paint(&self, ui: &mut Ui) -> ResponseBounds {
        ...
        return ResponseBounds::new(
            Rect {
                min: (pos - Vec2::new(w / 2.0, h / 2.0)),
                max: (pos + Vec2::new(w / 2.0, h / 2.0)),
            },
            None,
        );
    }
...
impl TankValvePainter {
    pub fn new(valve_painter: ValvePainter) -> Self {
        ...
        Self {
            ...
            handle_width_painter: LinePainter1D::new(vec![valve_pos, valve_pos - Vec2::new(0.0, handle_length)]),
        }
    }
}
    ...
    pub fn new(pos: Pos2, width: f32, height: f32) -> Self {
        ...
        for i in 0..CHECK_VALVE_SPIKE_NUM {
            ...
            points.push(Pos2::new(
                pos.x - width / 2.0 + padding + spike_width / 2.0 + (i as f32) * spike_width,
                pos.y + dir * height / 2.0,
            ));
        }
        ...
        Self {
            ...
            circle_painter: CirclePainter::new(
                Pos2::new(pos.x + width / 2.0 - padding - 1.5 * radius, pos.y),
                radius,
                true,
            ),
        }
