...
use crate::utils::mesh::{create_mesh_from_indices, ColoredTexture, TextureKey};
use super::math::{conversions::to_pos, transform::Transform};

const POSITIONS: [Point2<f32>; 4] = [Point2::new(0.0, 0.0), Point2::new(1.0, 0.0), Point2::new(1.0, 1.0), Point2::new(0.0, 1.0)];
const INDICES: [u32; 6] = [0, 1, 2, 0, 2, 3];

pub fn paint_missing(local_transform: &Transform, global_transform: &Affine2<f32>, painter: &egui::Painter) {
